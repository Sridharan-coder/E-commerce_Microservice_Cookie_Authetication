...
const Maintance = ({setIsMaintance}) => {

  const navigate=useNavigate()

  const handleMaintenance=()=>{
    setTimeout(()=>setIsMaintance(true),500)
      ...
      <article className='maintanceArticle'>
        ...
        <div>
          <p>
            ...
            you can check on{' '}
            <span className='PageNavigator' onClick={handleMaintenance} >Profile Information</span> , otherwise,
